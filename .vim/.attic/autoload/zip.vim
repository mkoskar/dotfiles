...
"  call Dfunc("zip#Browse(zipfile<".a:zipfile.">)")
  ...
  if !executable(g:zip_unzipcmd)
   redraw!
   echohl ErrorMsg | echo "***error*** (zip#Browse) unzip not available on your system"
...
"   call Dret("zip#Browse")
  ...
  if !filereadable(a:zipfile)
   if a:zipfile !~# '^\a\+://'
    ...
    redraw!
    echohl ErrorMsg | echo "***error*** (zip#Browse) File not readable<".a:zipfile.">" | echohl None
"    call inputsave()|call input("Press <cr> to continue")|call inputrestore()
   endif
   let &report= repkeep
...
"   call Dret("ZipBrowseSelect")
  ...
  if fname =~ '/$'
"   redraw!
"   echohl ErrorMsg | echo "***error*** (zip#Browse) Please specify a file, not a directory" | echohl None
"   call inputsave()|call input("Press <cr> to continue")|call inputrestore()
   let &report= repkeep
"   call Dret("ZipBrowseSelect")
   return
...
"  call Dfunc("zip#Write(fname<".a:fname.">) zipfile_".winnr()."<".s:zipfile_{winnr()}.">")
  ...
  if !executable(g:zip_zipcmd)
   redraw!
   echohl ErrorMsg | echo "***error*** (zip#Write) sorry, your system doesn't appear to have the zip pgm" | echohl None
"   call inputsave()|call input("Press <cr> to continue")|call inputrestore()
   let &report= repkeep
"   call Dret("zip#Write")
   return
  ...
  if !exists("*mkdir")
   redraw!
   echohl ErrorMsg | echo "***error*** (zip#Write) sorry, mkdir() doesn't work on your system" | echohl None
"   call inputsave()|call input("Press <cr> to continue")|call inputrestore()
   let &report= repkeep
"   call Dret("zip#Write")
   return
...
"  call Decho(g:zip_zipcmd." -u ".s:Escape(fnamemodify(zipfile,":p"),0)." ".s:Escape(fname,0))
  ...
  if v:shell_error != 0
   redraw!
   echohl ErrorMsg | echo "***error*** (zip#Write) sorry, unable to update ".zipfile." with ".fname | echohl None
"   call inputsave()|call input("Press <cr> to continue")|call inputrestore()
...
"  call Dfunc("ChgDir(newdir<".a:newdir."> errlvl=".a:errlvl."  errmsg<".a:errmsg.">)")
  ...
  try
   ...
   elseif a:errlvl == s:ERROR
    echohl ErrorMsg | echo "***error*** ".a:errmsg | echohl NONE
   endif
"   call inputsave()|call input("Press <cr> to continue")|call inputrestore()
"   call Dret("ChgDir 1")
   return 1
