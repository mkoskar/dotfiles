...
"    call Decho("exe ".s:netrw_silentxfer."!".g:netrw_scp_cmd.useport." ".shellescape(g:netrw_machine.":".b:netrw_fname,1)." ".shellescape(tmpfile,1))
    exe s:netrw_silentxfer."r!".g:netrw_scp_cmd.useport." ".shellescape(g:netrw_machine.":".b:netrw_fname,1)." ".shellescape(tmpfile,1)
    let result           = s:NetrwGetFile(readcmd, tmpfile, b:netrw_method)
    let b:netrw_lastfile = choice
...
"   call Decho("make local maps")
   ...
   nnoremap <buffer> <silent> <cr>	:exe "e ".<SID>NetrwBrowseChgDir(1,<SID>NetrwGetWord())<cr>
   ...
   nnoremap <buffer> <silent> -		:exe "e ".<SID>NetrwBrowseChgDir(1,'../')<cr>
...
"   call Decho("make remote maps")
   ...
   nnoremap <buffer> <silent> <cr>	:exe "e ".<SID>NetrwBrowseChgDir(0,<SID>NetrwGetWord())<cr>
   ...
   nnoremap <buffer> <silent> -		:exe "e ".<SID>NetrwBrowseChgDir(0,'../')<cr>
