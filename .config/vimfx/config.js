...
vimfx.set('mode.normal.find_highlight_all', 'a/ <space>')
...
vimfx.set('mode.normal.tab_move_backward', 'gJ <force><a-H>')
vimfx.set('mode.normal.tab_move_forward', 'gK <force><a-L>')
vimfx.set('mode.normal.tab_restore', 'X u')
vimfx.set('mode.normal.tab_restore_list', 'gX U')
vimfx.set('mode.normal.tab_select_next', 'K gt <force><a-l>')
vimfx.set('mode.normal.tab_select_previous', 'J gT <force><a-h>')
...
addInputCommand('input_end', 'Input: end', '<force><c-e> <force><a-e> <force><a-$>)')
addInputCommand('input_end_sel', 'Input: select end', '<force><c-E> <force><a-E>')
addInputCommand('input_erase', 'Input: erase', '<force><c-h>')
addInputCommand('input_esc', 'Input: escape', '<force><c-x>')
addInputCommand('input_home', 'Input: home', '<force><a-0>')
addInputCommand('input_home_sel', 'Input: select home', '<force><a-)>')
addInputCommand('input_kleft', 'Input: kill left', '<force><a-u>')
addInputCommand('input_kright', 'Input: kill right', '<force><c-k>')
addInputCommand('input_left', 'Input: left', '<force><c-b>')
addInputCommand('input_left_sel', 'Input: select left', '<force><c-B>')
addInputCommand('input_right', 'Input: right', '<force><c-f>')
addInputCommand('input_right_sel', 'Input: select right', '<force><c-F>')
addInputCommand('input_up', 'Input: up', '<force><c-p>')
addInputCommand('input_wdelete', 'Input: word delete', '<force><a-d> <force><a-X>')
